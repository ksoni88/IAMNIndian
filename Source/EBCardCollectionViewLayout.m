...
- (NSInteger)cardWidth
{
    NSInteger retVal = _cardWdth ? _cardWdth : self.collectionView.bounds.size.width - _offset.horizontal * 2;
    return retVal;
}

- (NSInteger)cardHeight
{
    NSInteger retVal = _cardHght ? _cardHght : self.collectionView.bounds.size.height - _offset.vertical * 2;
    return retVal;
}
