...
- (void)setup
{
    ...
    //  UILabel for title
    self._titleLabel = [[UILabel alloc] initWithFrame:CGRectZero];
    self._titleLabel.textAlignment = NSTextAlignmentRight;
    self._titleLabel.backgroundColor = [UIColor clearColor];
    self._titleLabel.font = [UIFont fontWithName:@"Helvetica-Bold" size:15];
    self._titleLabel.textColor = [UIColor yellowColor];
    self._titleLabel.shadowColor = [UIColor blackColor];
    self._titleLabel.shadowOffset = CGSizeMake(0, 1);
...
- (void)setMosaicData:(MosaicData*)newMosaicData
{
    ...
    //  Title set
    __titleLabel.text = _mosaicData.title;
}
...
- (void)layoutSubviews
{
    ...
    __titleLabel.frame = CGRectMake(kLabelMargin,
